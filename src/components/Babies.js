  ...
  return (
    ...
    <div class='container'>
        <div class='row'>
            <div class='col'>
                 <div className='blog'> 
        <h1 style={{marginTop:'10%' ,marginLeft:'5%',fontFamily:'initial'}}>BABIES</h1>
        <br></br>
                      ...
                      <div class='col ms-5' >
                                  ...
                                  <ul>
                                   ...
                                   <li> <Link style={{textDecoration:'none'}}  to='/ Exploring the duis lacus turpis faucibus'   >Exploring the duis lacus turpis faucibus</Link></li>
                                     ...
                                     <ul >
                                      <li style={{marginTop:'39%', }}>Recent post</li>
                                    <li> <Link style={{textDecoration:'none'}} to='/Babies'   >Babies</Link></li>         <li> <Link style={{textDecoration:'none'}} to='/Play Spaces'   >Play Spaces</Link></li>
